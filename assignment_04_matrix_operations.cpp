...
int main() {
    ...
    cout << "Matrix A:" << endl;
    readMatrix(matA, aRows, aCols);
    cout << "Matrix B:" << endl;
    readMatrix(matB, aRows, aCols);

    addMatrices(matA, matB, aRows, aCols, sumResult);

    cout << "\nSum Matrix:" << endl;
    printMatrix(sumResult, aRows, aCols);

    // ----- PART C: Multiplication -----
    int mRowsA, mColsA, mColsB;
    int matM[10][10], matN[10][10], productResult[10][10];
    ...
    cout << "Matrix A:" << endl;
    readMatrix(matM, mRowsA, mColsA);
    cout << "Matrix B:" << endl;
    readMatrix(matN, mColsA, mColsB);

    multiplyMatrices(matM, matN, mRowsA, mColsA, mColsB, productResult);

    cout << "\nProduct Matrix:" << endl;
    printMatrix(productResult, mRowsA, mColsB);
